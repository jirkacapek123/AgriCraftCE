...
| Version  | Notes
|----------|:----------
|[![1.7.10](https://github.com/jirkacapek123/AgriCraftCE/actions/workflows/gradle.yml/badge.svg?branch=1.7.10)](https://github.com/jirkacapek123/AgriCraftCE/actions/workflows/gradle.yml) | One more release to end the 1.7.10 chapter will be done, fixing all bugs from the previous version.
